...
const rules: Rule[] = [
  ...
  },
  {
    ...
    reply:
      "You can reach us on WhatsApp at +91 99999 99999 or email hello@visaguru.live. For a structured start, submit free refusal analysis from the homepage.",
  },
  {
...
export async function POST(request: NextRequest) {
  ...
  return NextResponse.json({
    reply:
      match?.reply ??
      "Please share your visa type and refusal reason for specific guidance. You can also use free refusal analysis from the homepage or WhatsApp +91 99999 99999 for human support.",
  });
}
