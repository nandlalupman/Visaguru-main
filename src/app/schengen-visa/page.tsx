...
export async function generateMetadata(): Promise<Metadata> {
  const service = await getServiceBySlug("schengen-visa");
...
export default async function SchengenVisaPage() {
  const [service, sharedConfig] = await Promise.all([
    getServiceBySlug("schengen-visa"),
